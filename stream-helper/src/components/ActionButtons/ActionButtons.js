...
import { Bookmark, HandThumbsUp,HandThumbsDown, Check2  } from 'react-bootstrap-icons';
...
function ActionButtons(props) {
    ...
    return (
      ...
      <Button className="actionButtonBox" onClick={() => {
              submitSave();
            ...
            }}>  <Bookmark color={"white"} size={25} className="movieDetailHeartIcon"/> Save</Button>
      <Button className="actionButtonBox" onClick={(e) => {
                submitWatched(e);
              ...
              }}>  <Check2 color={"white"} size={25} className="movieDetailHeartIcon"/> Watched</Button>
      <Button className="actionButtonBox">  <HandThumbsUp color={"white"} size={25} className="movieDetailHeartIcon"/> Like</Button>
      <Button className="actionButtonBox" onClick={(e) => {
              ...
              }}>  <HandThumbsDown  color={"white"} size={25} className="movieDetailHeartIcon"/> Dislike</Button>
