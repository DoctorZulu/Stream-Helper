...
import { StarFill, StarHalf, Star, Bookmark, HandThumbsUp,HandThumbsDown, Check2  } from 'react-bootstrap-icons';
    ...
    <>
      ...
      <Container className="mainMovieDetailContainer"> 
        <Row>
          ...
          <br/>
          <br/>
            <h4> Rating: {currentMovieDetails.movie.vote_average /2 } 
          <StarRatings
        ...
        />
          ...
          <h5> Original Language: {currentMovieDetails.movie.original_language}</h5>
          <h5> Release Date: {currentMovieDetails.movie.release_date}</h5>
          </div>
          ...
          <div className="movieDetailContent">
            ...
            <h4> Movie Description: {currentMovieDetails.movie.overview}</h4>
